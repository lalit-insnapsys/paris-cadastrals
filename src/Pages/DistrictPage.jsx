...
const DistrictPage = () => {
  ...
  useEffect(() => {
    const fetchStreets = async () => {
      try {
        const apiUrl = `https://opendata.paris.fr/api/records/1.0/search/?dataset=denominations-emprises-voies-actuelles&rows=1000&refine.arrdt=${districtCode.toString().slice(-2)}e`;
